...
Some typical rocket fuels and oxidizers are shown in *@5-typical-liquid-fuels*.
...
#figure(
  table(
    ...
    table.header[*Chemical \ Formula*][*Name*][*Comments*],
    table.cell(colspan: 3, [*Liquid Fuels*]),
    [#ce("N2H4")],
    [Hydrazine],
    [
      - Typically used in monopropellent systems.
      - Too energetic for bipropellent, unstable burning..
    ],
    [#ce("CH3NHNH2")],
    [Monomethylhydrazine],
    [
      - Also known as MMH, commonly used in space.
      - Easy to store, does not decompose over time.
      - High density, high performance.
      - Burns well and *hyperglocially* with #ce("N2O4").
      - Used commonly in the west, sometimes used in launch vehicles as well.
    ],
    [#ce("(CH3)2NNH2")], [Unsymmetrical Dimethylhydrazine], [- Also known as UDMH, same benefits as MMH.],
    [#ce("H2")],
    [Hydrogen],
    [
      - Is typically used in launch vehicles.
      - Not used in space due to requiring cryogenic temperatures to avoid boil off.
      - Pairs well with #ce("O2").
    ],
    [$"C"_"n""H"_"1.97n"$],
    [RP1],
    [
      - RP1 stands for Rocket Propellent Group 1 and is essentially a form of kerosene.
      - Usually burnt with #ce("O2").
    ],
    [#ce("C2H4")],
    [Methane],
    [
      - Is used in Starship and Blue Origin.
      - Usually burnt with #ce("O2").
    ],
    [#ce("C2H5OH")],
    [Ethanol],
    [
      - Was hystorically used as a fuel for roekcts.
      - Was burnt with #ce("H2O2").
    ],
    [#ce("B5H9")],
    [Pentaborane],
    [
      - Possibly the best rocket fuel developed.
      - Very hypergolic making it essentially unusable.
    ],
    table.cell(colspan: 3, [*Liquid Oxidizers*]),
    [#ce("O2")], [Oxygen], [- Is the most commonly oxidizer.],
    [#ce("N2O4")],
    [Dinitrogen Tetroxide],
    [
      - Burns well and *hyperglocially* with #ce("CH3NHNH2") or #ce("(CH3)2NNH2").
      - Is not always Di as this depends on $T_c$.
    ],
    [#ce("H2O2")],
    [Hydrogen Peroxide],
    [
      - Was historically used as an oxidizer with #ce("C2H5OH").
    ],
    [#ce("HNO3")],
    [Nitric Acid],
    [
      - Was historically used as an oxidizer.
    ],
    [C#ce("IF3")],
    [Chlorine Trifluoride],
    [
      - Extremely high performance.
      - Very reactive, poisonous, toxic and corrosive to the point where it is difficult to use.
      - Can be hypergolic with some fuels.
    ],
    [#ce("OF2")],
    [Oxygen Diflouride],
    [
  ...
  caption: [The name of typical liquid fuels and oxidizers.],
)<5-typical-liquid-fuels>
